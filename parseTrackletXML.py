...
class Tracklet(object):
    ...
    def get_for_frame(self, frame_idx: int):

        idx = frame_idx - self.firstFrame

        return self.trans[idx], self.rots[idx], self.states[idx], self.occs[idx], self.truncs[idx], None, None
