...
calib_keys = ['T_velo_imu', 'T_cam0_velo_unrect', 'P_rect_00', 'P_rect_10', 'P_rect_20', 'P_rect_30', 'R_rect_00', 'R_rect_10', 'R_rect_20', 'R_rect_30', 'T_cam0_velo', 'T_cam1_velo', 'T_cam2_velo', 'T_cam3_velo', 'K_cam0', 'K_cam1', 'K_cam2', 'K_cam3', 'b_gray', 'b_rgb', 'T_cam0_imu', 'T_cam1_imu', 'T_cam2_imu', 'T_cam3_imu']

CalibData = namedtuple('CalibData', calib_keys)
...
class raw:
    ...
    def _load_calib(self):
        ...
        self.calib = CalibData(*data.values())
